...
async function mailer(email, userID){
  try{
 ...
 const details = {
 from: '"Amazon Clone - User Verification" <useretheharsh0408@gmail.com>',
 to: email,
 ...
 return result;
  ...
  console.log("There might be error in SMTP server or App's Server, Please check back after some time.")
  }
}
